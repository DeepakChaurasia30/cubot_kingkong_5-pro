...
BOOT_LOGO = te826_cq_bo21c_62_r0_eea_hdplus1560
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
#camera
CUSTOM_HAL_IMGSENSOR = s5kgm1sp_mipi_raw s5k2x5sp_mipi_raw s5k5e2ya_mipi_raw gc032a_mipi_raw gc8034_mipi_raw gc8034main_mipi_raw gc5035_mipi_raw imx576_mipi_raw ov5670_mipi_raw gc030a_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1sp_mipi_raw gc8034main_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = s5k2x5sp_mipi_raw gc8034_mipi_raw imx576_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =

CUSTOM_KERNEL_IMGSENSOR = s5kgm1sp_mipi_raw s5k2x5sp_mipi_raw s5k5e2ya_mipi_raw gc032a_mipi_raw gc8034_mipi_raw gc8034main_mipi_raw gc5035_mipi_raw imx576_mipi_raw ov5670_mipi_raw gc030a_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1sp_mipi_raw gc8034main_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k2x5sp_mipi_raw gc8034_mipi_raw imx576_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
ODM_FEATURE_FAKE_SUB2_CAMERA_SUPPORT = yes
...
WTK_BUILD_VERNO = CUBOT_KINGKONG 5 Pro_B021C_V14_20220708
WTK_INTERNAL_BUILD_VERNO = TE826_CQ_B021C_62_R0_EEA_V2.7.1_S220708
...
FINGERPRINT_MICROARRAY_A128N_REE = no
FINGERPRINT_MICROARRAY_A128N_TEE = no
FINGERPRINT_MICROARRAY_A128NS_TEE = yes

#add by GMS start
BUILD_GMS = yes
WTK_CLIENTID_CUSTOM = cubot
CUSTOM_GMS_TYPE = eea
CUSTOM_CAMERA_NOTCH = yes
WTK_CAMERA_SUPPORT_IMAGE_N=3
ANDROID_PARTNER_GMS_HOME = google_202103
#add by GMS end

#add for ota diff tool start
WTK_OTA_DIFF_TOOL = yes
#add for ota diff tool end

#add by liulei for TEBEL-49 20210104 start
WTK_TARGET_BOARD_NAME = CUBOT
#add by liulei for TEBEL-49 20210104 end

#add custom signal start
WTK_CUSTOM_SIGNAL = cq
#add custom signal end

#add SIP support start
OPPO_SIP_SUPPORT = yes
#add SIP support end

#add by liulei for fingerprint_date_show 20210104 start
WTK_FINGERPRINT_SHOW_DATE = yes
#add by liulei for fingerprint_date_show 20210104 end

# Add by zhiheng.huang on 2020/3/12 for TEJWQE-61 start
BUILD_GMS_OOBCONFIG_SUPPORT = yes
# Add by zhiheng.huang on 2020/3/12 for TEJWQE-61 end

# Add by huziwei on 2021/01/05 for TEBEL-66 start
WTK_PTP_LABEL = KINGKONG 5 Pro
WTK_MTP_LABEL = KINGKONG 5 Pro
ODM_CYEEFRAMEWORK_SUPPORT = yes
# Add by huziwei on 2021/01/05 for TEBEL-66 end

# Add by chenyu 20210107 for TEBEL-153 start
CUSTOM_DEFAULT_RINGTONE = Ring_Classic_02.ogg
# Add by chenyu 20210107 for TEBEL-153 end

POWEROFF_CHARGING_LED_BLINK=yes

# A: Bug_id:TEBEL-121 chenchunyong 20210111 {
WTK_MULTISIM_RINGTONE_SUPPORT = yes
# A: }

# A: Bug_id:TELWL-430 chenchunyong 20201214 {
WTK_OVERRIDES_ORIGINAL_MUSIC = yes
# A: }

#add by chenyu for TEBEL-213 20210120 start
WTK_SMART_NAVIBAR_SUPPORT = yes
#add by chenyu for TEBEL-213 20210120 end

# A: add Cyee Camera chenchunyong 20190816 {
CY_CAMERA_FEATURE_SUPPORT = yes

CY_CHENYEE_FEATURE_SUPPORT = yes
CY_CHENYEE_LIVEEFFECT_SUPPORT = no
...
CY_MORPHO_LOWLIGHT_SUPPORT = no
CY_MORPHO_HDR_SUPPORT = no
# A: }

#add audio awinic algorithm
WTK_AWINIC_ALGORITHM = yes
WTK_AWINIC_ALGORITHM_5_3_2_AFTER = yes

#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = yes
#FACE_UNLOCK_SUPPORT end

#add by Incoming call full screen start
WTK_CALL_ALWAYS_FULLSCREEN = yes
#add by Incoming call full screen end

#add bug:TEBEL-494 wushanfei 20210129 start
FM_ALLOW_PORTRAIT_DISPLAY = yes
#add bug:TEBEL-494 wushanfei 20210129 end

#add bug_id:TEBEL-517 donghao start
WTK_DESKCLOCK_SUPPORT = yes
#add bug_id:TEBEL-517 donghao end

#add TEBEL-491 by zhangxudong 20210301(start)
WTK_SHOW_4G_FOR_LTE = yes
#add TEBEL-491 by zhangxudong 20210301(end)

#add TEBEL-81 donghao 20210302(start)
WTK_CUSTOM_DATA_ROAMING_SUPPORT = yes
#add TEBEL-81 donghao 20210302(end)

#modify by chenxinfeng BUG_ID:TEBEL-615 20210302 (start)
ODM_CAM_SUPPORT_EIS=yes
#modify by chenxinfeng BUG_ID:TEBEL-615 20210302 (end)

PLATFORM_BASE_OS = CUBOT/KINGKONG_5_Pro_EEA/KINGKONG_5_Pro:11/RP1A.200720.011/20210421:user/release-keys
